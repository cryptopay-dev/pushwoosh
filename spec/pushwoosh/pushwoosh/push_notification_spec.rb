...
describe Pushwoosh::PushNotification do
  ...
  describe '#notify_all' do
    ...
    context 'when message is empty' do
      it 'raises message is missing error' do
        expect do
          subject.notify_all('')
        end.to raise_error Pushwoosh::Exceptions::Error, 'Message is missing'
      end
    end
  end
  ...
  describe '#notify_devices' do
    let(:devices) do
      %w[dec301908b9ba8df85e57a58e40f96f523f4c2068674f5fe2ba25cdc250a2a41
    ...
    let(:request) do
      {
        notification_options: {
          ...
          ios_badges: '+1',
          content:    'Testing',
          devices: %w[dec301908b9ba8df85e57a58e40f96f523f4c2068674f5fe2ba25cdc250a2a41
                      bec301908b9ba8df85e57a58e40f96f523f4c2068674f5fe2ba25cdc250a2a41]
        },
        auth: '5555-5555',
        application: '555555'
